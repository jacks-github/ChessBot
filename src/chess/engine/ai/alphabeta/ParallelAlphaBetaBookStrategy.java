...
public class ParallelAlphaBetaBookStrategy extends AlphaBetaBookStrategy
{

	public ParallelAlphaBetaBookStrategy(final int depth, final JTextArea outputTextArea)
	{
	...
	{
		return "Parallel AlphaBeta (Book)";
	}
